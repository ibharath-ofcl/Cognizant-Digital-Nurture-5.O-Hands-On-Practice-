...
import com.example.employeemanagementsystem.service.EmployeeBatchService;
...
public class EmployeeController {
    ...
    public EmployeeController(EmployeeRepository employeeRepository, DepartmentRepository departmentRepository, EmployeeBatchService employeeBatchService) {
        ...
        for (Employee employee : employees) {
            if (employee.getDepartment() != null && employee.getDepartment().getId() != null) {
                Department department = departmentRepository.findById(employee.getDepartment().getId())
                        .orElseThrow(() -> new IllegalArgumentException("Invalid department ID: " + employee.getDepartment().getId()));
    ...
    @PutMapping("/batch")
    public ResponseEntity<Void> updateEmployeesBatch(@RequestBody List<Employee> employees) {
        for (Employee employee : employees) {
            if (employee.getDepartment() != null && employee.getDepartment().getId() != null) {
                Department department = departmentRepository.findById(employee.getDepartment().getId())
                        .orElseThrow(() -> new IllegalArgumentException("Invalid department ID: " + employee.getDepartment().getId()));
        ...
        employeeBatchService.updateEmployeesInBatch(employees);
