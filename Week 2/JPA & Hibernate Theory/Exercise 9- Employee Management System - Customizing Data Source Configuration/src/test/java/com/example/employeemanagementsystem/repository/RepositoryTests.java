...
@Import({PrimaryDataSourceConfig.class, SecondaryDataSourceConfig.class})
class RepositoryTests {
    ...
    @Test
    void testProjectRepositorySecondaryDatabase() {
        ...
        assertThat(saved.getId()).isNotNull();
        assertThat(saved.getName()).isEqualTo("Project Gamma");
        assertThat(saved.getBudget()).isEqualTo(500000.0);

        List<Project> found = projectRepository.findByNameContainingIgnoreCase("gamma");
        assertThat(found).hasSize(1);
        assertThat(found.get(0).getName()).isEqualTo("Project Gamma");
    }
}
